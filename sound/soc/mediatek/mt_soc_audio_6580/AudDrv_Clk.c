...
void AudDrv_Clk_On(void)
{
    ...
    if (Aud_AFE_Clk_cntr == 0)
    {
        ...
        {
            xlog_printk(ANDROID_LOG_ERROR, "Sound", "Aud enable_clock MT_CG_AUD_PDN_AFE_EN fail !!!\n");
        }
        
        if (enable_clock(MT_CG_AUD_PDN_DAC_EN, "AUDIO"))
        {
            xlog_printk(ANDROID_LOG_ERROR, "Sound", "Aud enable_clock MT_CG_AUD_PDN_DAC_EN fail !!!\n");
        }
...
void AudDrv_Clk_Off(void)
{
    ...
    if (Aud_AFE_Clk_cntr == 0)
    {
        printk("------------AudDrv_Clk_Off, Aud_AFE_Clk_cntr:%d \n", Aud_AFE_Clk_cntr);
        {
            ...
            {
                xlog_printk(ANDROID_LOG_ERROR, "Sound", "disable_clock MT_CG_AUD_PDN_AFE_EN fail");
            }
            
            if (disable_clock(MT_CG_AUD_PDN_DAC_EN, "AUDIO"))
            {
                xlog_printk(ANDROID_LOG_ERROR, "Sound", "disable_clock MT_CG_AUD_PDN_DAC_EN fail");
            }
    #if 0   //Rainier no need
...
void AudDrv_ADC_Clk_On(void)
{
    ...
    if (Aud_ADC_Clk_cntr == 0)
    {
        ...
        {
            xlog_printk(ANDROID_LOG_ERROR, "Sound", "Aud enable_clock MT_CG_AUD_PDN_ADC_EN fail !!!\n");
        }
#else
...
void AudDrv_ADC_Clk_Off(void)
{
    ...
    if (Aud_ADC_Clk_cntr == 0)
    {
        ...
        {
            xlog_printk(ANDROID_LOG_ERROR, "Sound", "disable_clock MT_CG_AUD_PDN_ADC_EN fail");
        }
#else
...
void AudDrv_Suspend_Clk_Off(void)
{
    ...
    if (Aud_Core_Clk_cntr > 0)
    {
        ...
        if (Aud_AFE_Clk_cntr  > 0)
        {
            if (disable_clock(MT_CG_AUD_PDN_AFE_EN, "AUDIO"))
            {
                xlog_printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Suspend_Clk_Off enable_clock MT_CG_AUD_PDN_AFE_EN fail !!!\n");
            }
        }
        if (Aud_I2S_Clk_cntr > 0)
        {
        ...
        if (Aud_ADC_Clk_cntr > 0)
        {
            if (disable_clock(MT_CG_AUD_PDN_ADC_EN, "AUDIO"))
            {
                xlog_printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Suspend_Clk_Off enable_clock MT_CG_AUD_PDN_ADC_EN fail !!!\n");
            }
            //Afe_Set_Reg(AUDIO_TOP_CON0, 1 << 24 , 1 << 24);
        }
        if (Aud_ADC2_Clk_cntr > 0)
...
void AudDrv_Suspend_Clk_On(void)
{
    ...
    if (Aud_Core_Clk_cntr > 0)
    {
        ...
        if (Aud_AFE_Clk_cntr  > 0)
        {
            if (enable_clock(MT_CG_AUD_PDN_AFE_EN, "AUDIO"))
            {
                xlog_printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Suspend_Clk_On enable_clock MT_CG_AUD_PDN_AFE_EN fail !!!\n");
            }
        }
        if (Aud_I2S_Clk_cntr > 0)
        {
        ...
        if (Aud_ADC_Clk_cntr > 0)
        {
            if (enable_clock(MT_CG_AUD_PDN_ADC_EN, "AUDIO"))
            {
                xlog_printk(ANDROID_LOG_ERROR, "Sound", "AudDrv_Suspend_Clk_On enable_clock MT_CG_AUD_PDN_ADC_EN fail !!!\n");
            }
            //Afe_Set_Reg(AUDIO_TOP_CON0, 0 << 24 , 1 << 24);
        }
        if (Aud_ADC2_Clk_cntr > 0)
