...
#include <mach/pmic_mt6323_sw.h>    //Rainier use mt6350
#endif
...
//const unsigned int AudioSramPlaybackFullSize = 1024 * 48; //K2 setting
const unsigned int AudioSramPlaybackFullSize = 1024 * 16; //82 only has 16K

const unsigned int AudioSramPlaybackPartialSize = 1024 * 32;
//const unsigned int AudioDramPlaybackSize = 1024 * 48; //k2's setting
const unsigned int AudioDramPlaybackSize = 1024 * 16;   //82 use 16K

//const size_t AudioSramCaptureSize = 1024 * 48;    //K2 setting
...
{
//#define Dl1_MAX_BUFFER_SIZE     (48*1024) //k2 use
...
#ifdef CONFIG_OF
#if 1   //Sammodi 82 no, but might need it on Rainier
...
#else
    PRINTK_AUDDRV("Auddrv_DAI_Interrupt_Handler 82 no this \n");
#endif
}
