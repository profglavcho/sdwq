...
#define GC0310_TEST_PATTERN_CHECKSUM (0x6cd0a60e)
...
void GC0310_Sensor_Init(void)
{
    ...
    CamWriteCmosSensor(0xf2,0x01); //sync output
    CamWriteCmosSensor(0xf3,0x83); //ff//1f//01 data output
    CamWriteCmosSensor(0xf5,0x07); //sck_dely
    CamWriteCmosSensor(0xf7,0x8b); //f8//fd
    CamWriteCmosSensor(0xf8,0x03);
    CamWriteCmosSensor(0xf9,0x4e); //0f//01
    ...
    CamWriteCmosSensor(0x16,0x00); //0x10 : 66.62ms, 0x11 : 66.75ms
    ...
    CamWriteCmosSensor(0x33,0x10); //offset_ratio
    CamWriteCmosSensor(0x37,0x20); //dark_current_ratio
        CamWriteCmosSensor(0x38,0x10); //dark_current_ratio
...
//??
    ...
    CamWriteCmosSensor(0x53,0x24); //24
    CamWriteCmosSensor(0x54,0x20);
    CamWriteCmosSensor(0x55,0x00); //QQ//01
    CamWriteCmosSensor(0x5a,0x00); //00 //yuv
