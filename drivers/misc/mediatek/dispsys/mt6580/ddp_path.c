...
/*PRIMARY_DISP*/             {DISP_MODULE_OVL0,  DISP_MODULE_COLOR0, DISP_MODULE_AAL,   DISP_MODULE_GAMMA, DISP_MODULE_DITHER, DISP_MODULE_RDMA0, /*DISP_MODULE_UFOE,*/ DISP_MODULE_PWM0, DISP_MODULE_DSI0, -1, -1, -1, -1},
...
/*PRIMARY_ALL*/              {DISP_MODULE_OVL0,  DISP_MODULE_WDMA0,  DISP_MODULE_COLOR0, DISP_MODULE_AAL,   DISP_MODULE_GAMMA,  DISP_MODULE_DITHER,DISP_MODULE_RDMA0,/*DISP_MODULE_UFOE,*/ DISP_MODULE_PWM0, DISP_MODULE_DSI0, -1, -1, -1},
...
void ddp_connect_path(DDP_SCENARIO_ENUM scenario, void * handle)
{
    ...
    {
        ddp_connect_path_l(module_list_scenario[DDP_SCENARIO_SUB_RDMA1_DISP], handle);
    }
    else
    {
...
void ddp_disconnect_path(DDP_SCENARIO_ENUM scenario,void * handle)
{
    ...
    {
        ddp_disconnect_path_l(module_list_scenario[DDP_SCENARIO_SUB_RDMA1_DISP], handle);
    }
    else
    {
...
void ddp_check_path(DDP_SCENARIO_ENUM scenario)
{
    ...
    {
        ddp_check_path_l(module_list_scenario[DDP_SCENARIO_SUB_RDMA1_DISP]);
    }
    else
    {
