...
{	\
	...
	mt_reg_sync_writel(0x2,(volatile unsigned long*)(MIPITX_BASE+0x14));		\
	mt_reg_sync_writel(0x1,(volatile unsigned long*)(MIPITX_BASE+0x18));		\
	mt_reg_sync_writel(((unsigned int)slave_addr << 0x1),(volatile unsigned long*)(MIPITX_BASE+0x04));		\
	mt_reg_sync_writel(write_addr,(volatile unsigned long*)(MIPITX_BASE+0x0));		\
	mt_reg_sync_writel(write_data,(volatile unsigned long*)(MIPITX_BASE+0x0));		\
	mt_reg_sync_writel(0x1,(volatile unsigned long*)(MIPITX_BASE+0x24));		\
	while(INREG32((volatile unsigned long*)(MIPITX_BASE+0xC))&0x1 != 0x1) mdelay(10);		\
	mt_reg_sync_writel(0xFF,(volatile unsigned long*)(MIPITX_BASE+0xC));		\
	\
	mt_reg_sync_writel(0x1,(volatile unsigned long*)(MIPITX_BASE+0x14));		\
	mt_reg_sync_writel(0x1,(volatile unsigned long*)(MIPITX_BASE+0x18));		\
	mt_reg_sync_writel(((unsigned int)slave_addr << 0x1),(volatile unsigned long*)(MIPITX_BASE+0x04));		\
	mt_reg_sync_writel(write_addr,(volatile unsigned long*)(MIPITX_BASE+0x0));		\
	mt_reg_sync_writel(0x1,(volatile unsigned long*)(MIPITX_BASE+0x24));		\
	...
	mt_reg_sync_writel(0x1,(volatile unsigned long*)(MIPITX_BASE+0x14));		\
	mt_reg_sync_writel(0x1,(volatile unsigned long*)(MIPITX_BASE+0x18));		\
	mt_reg_sync_writel(((unsigned int)slave_addr << 0x1)+1,(volatile unsigned long*)(MIPITX_BASE+0x04));		\
	mt_reg_sync_writel(0x1,(volatile unsigned long*)(MIPITX_BASE+0x24));		\
	while(INREG32((volatile unsigned long*)(MIPITX_BASE+0xC))&0x1 != 0x1) ;		\
	mt_reg_sync_writel(0xFF,(volatile unsigned long*)(MIPITX_BASE+0xC));		\
	read_data1 = INREG32((volatile unsigned long*)(MIPITX_BASE));		\
	read_data2 = INREG32((volatile unsigned long*)(MIPITX_BASE));		\
	printk("MIPI write data = 0x%x, read data = 0x%x, 0x%x\n", write_data, read_data1, read_data2);		\
	if(read_data2 == write_data)printk("MIPI write success\n");		\
...
int ddp_dsi_init(DISP_MODULE_ENUM module, cmdqRecHandle cmdq)
{
	...
	DSI_OUTREG32(cmdq, DISP_REG_CONFIG_MMSYS_CG_CLR0, 0xffffffff);
	DSI_OUTREG32(cmdq, DISP_REG_CONFIG_MMSYS_CG_CLR1, 0xffffffff);
	...
	printk("dsi_init: dsi = 0x%lx, mipi = 0x%lx, dsi_cmdq = 0x%lx\n",(unsigned long)DSI_REG[0],(unsigned long)DSI_PHY_REG[0],(unsigned long)DSI_CMDQ_REG[0]);
