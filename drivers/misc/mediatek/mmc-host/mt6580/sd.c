    ...
    switch(host->id){
        case 1:
            ...
            if (host->hw->flags & MSDC_SD_NEED_POWER) {
                msdc_ldo_power(1, MSDC_VMC, 3000000, &g_msdc1_io);
                msdc_ldo_power(1, MSDC_VMCH, 3000000, &g_msdc1_flash);
            }
            else {
                msdc_ldo_power(on, MSDC_VMC, 3000000, &g_msdc1_io);
                msdc_ldo_power(on, MSDC_VMCH, 3000000, &g_msdc1_flash);
            }
            break;
