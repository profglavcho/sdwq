...
#if CFG_WMT_FILTER_MODE_SETTING
	if((0x6580 == wmt_ic_ops_soc.icId)||(0x6752 == wmt_ic_ops_soc.icId) || (0x6582 == wmt_ic_ops_soc.icId) || (0x6592 == wmt_ic_ops_soc.icId))
	{
...
wmt_stp_wifi_lte_coex (VOID)
{
	...
	{
		if((0x6752 == wmt_ic_ops_soc.icId) || (0x6580 == wmt_ic_ops_soc.icId))
