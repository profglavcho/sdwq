...
static int slp_auto_suspend_resume_thread_handler(void *unused)
{
    do
    {
		...
		//FIXME: check with charging owner
        //charging_suspend_enable();
...
#if 0 // FIXME: check with mt_clkmgr.c for pll check function
...
void slp_module_init(void)
{
    ...
    // FIXME: for bring up. Important!!! default should be OFF
    #if 0
...
#ifdef CONFIG_MTK_FPGA
//TODO: Should not do spm_module_init for FPGA case. is it ?
/*
