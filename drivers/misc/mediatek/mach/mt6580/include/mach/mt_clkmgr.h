...
/* MMSYS Register      */
/***********************/
#define MMSYS_CG_CLR0 		(CLK_MMSYS_CONFIG_BASE + 0x100)
#define MMSYS_CG_CLR1		(CLK_MMSYS_CONFIG_BASE + 0x110)
/***********************/
/* IMGSYS Register     */
/***********************/
...
/* CG_MMSYS_CON1       */
/***********************/
#define DISP_PWM_MM_BIT		BIT(0)
#define DISP_PWM_26M_BIT	BIT(1)
#define DSI_ENGINE_BIT		BIT(2)
#define DSI_DIGITAL_BIT		BIT(3)
#define DPI_PIXEL_BIT		BIT(4)
#define DPI_ENGINE_BIT		BIT(5)

#define CG_MMSYS1_MASK         (DISP_PWM_MM_BIT		   \
                              | DISP_PWM_26M_BIT		   \
                              | DSI_ENGINE_BIT		   \
                              | DSI_DIGITAL_BIT		   \
                              | DPI_PIXEL_BIT	   \
...
/* CG_MFGSYS_CON       */
/***********************/
#define BG3D_SET_BIT		BIT(0)
#define BG3D_CLR_BIT		BIT(0)
#define CG_IMGSYS_MASK		(BG3D_SET_BIT	\
				| BG3D_CLR_BIT)
...
//	MT_CLKMUX_EMIDCM_DDRPHY_CLKSRC,
