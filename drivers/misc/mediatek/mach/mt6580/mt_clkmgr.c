...
{
// CG_MIXED
[MT_CG_SYS_26M]		= { .name = __stringify(MT_CG_SYS_26M),		.mask = BIT(0),		.ops = &ao_cg_clk_ops,		.grp = &grps[CG_MIXED], .src = MT_CG_INVALID,  }, // pll
//[MT_CG_UNIV_48M]	= { .name = __stringify(MT_CG_UNIV_48M),	.mask = UNIV48M_EN_BIT,	.ops = &wo_clr_cg_clk_ops,	.grp = &grps[CG_MIXED], .src = MT_CG_INVALID,  }, // pll
[MT_CG_USB_48M]		= { .name = __stringify(MT_CG_USB_48M),		.mask = USB48M_EN_BIT,	.ops = &wo_clr_cg_clk_ops,	.grp = &grps[CG_MIXED], .src = MT_CG_INVALID,  }, // pll
// CG_MPLL
[MT_CG_MPLL_D2]  = { .name = __stringify(MT_CG_MPLL_D2),  .mask = MPLL_D2_EN_BIT,    .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_INVALID,  }, // pll
[MT_CG_MPLL_D3]  = { .name = __stringify(MT_CG_MPLL_D3),  .mask = MPLL_D3_EN_BIT,    .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_INVALID,  }, // pll
[MT_CG_MPLL_D5]  = { .name = __stringify(MT_CG_MPLL_D5),  .mask = MPLL_D5_EN_BIT,    .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_INVALID,  }, // pll
[MT_CG_MPLL_D7]  = { .name = __stringify(MT_CG_MPLL_D7),  .mask = MPLL_D7_EN_BIT,    .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_INVALID,  }, // pll
[MT_CG_MPLL_D11] = { .name = __stringify(MT_CG_MPLL_D11), .mask = MPLL_D11_EN_BIT,   .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_INVALID,  },
[MT_CG_MPLL_D4]  = { .name = __stringify(MT_CG_MPLL_D4),  .mask = MPLL_D4_EN_BIT,    .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_MPLL_D2,  },
[MT_CG_MPLL_D6]  = { .name = __stringify(MT_CG_MPLL_D6),  .mask = MPLL_D6_EN_BIT,    .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_MPLL_D3,  },
[MT_CG_MPLL_D10] = { .name = __stringify(MT_CG_MPLL_D10), .mask = MPLL_D10_EN_BIT,   .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_MPLL_D5,  },
[MT_CG_MPLL_D14] = { .name = __stringify(MT_CG_MPLL_D14), .mask = MPLL_D14_EN_BIT,   .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_MPLL_D7,  },
[MT_CG_MPLL_D8]  = { .name = __stringify(MT_CG_MPLL_D8),  .mask = MPLL_D8_EN_BIT,    .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_MPLL_D4,  },
[MT_CG_MPLL_D12] = { .name = __stringify(MT_CG_MPLL_D12), .mask = MPLL_D12_EN_BIT,   .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_MPLL_D6,  },
[MT_CG_MPLL_D20] = { .name = __stringify(MT_CG_MPLL_D20), .mask = MPLL_D20_EN_BIT,   .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_MPLL_D10, },
[MT_CG_MPLL_D28] = { .name = __stringify(MT_CG_MPLL_D28), .mask = MPLL_D28_EN_BIT,   .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_MPLL_D14, },
[MT_CG_MPLL_D16] = { .name = __stringify(MT_CG_MPLL_D16), .mask = MPLL_D16_EN_BIT,   .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_MPLL_D8,  },
[MT_CG_MPLL_D24] = { .name = __stringify(MT_CG_MPLL_D24), .mask = MPLL_D24_EN_BIT,   .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_MPLL_D12, },
[MT_CG_MPLL_D40] = { .name = __stringify(MT_CG_MPLL_D40), .mask = MPLL_D40_EN_BIT,   .ops = &general_en_cg_clk_ops, .grp = &grps[CG_MPLL], .src = MT_CG_MPLL_D20, },

// CG_UPLL
[MT_CG_UPLL_D2]  = { .name = __stringify(MT_CG_UPLL_D2),  .mask = UPLL_D2_EN_BIT,  .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_INVALID,  }, // pll
[MT_CG_UPLL_D3]  = { .name = __stringify(MT_CG_UPLL_D3),  .mask = UPLL_D3_EN_BIT,  .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_INVALID,  }, // pll
[MT_CG_UPLL_D5]  = { .name = __stringify(MT_CG_UPLL_D5),  .mask = UPLL_D5_EN_BIT,  .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_INVALID,  }, // pll
[MT_CG_UPLL_D7]  = { .name = __stringify(MT_CG_UPLL_D7),  .mask = UPLL_D7_EN_BIT,  .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_INVALID,  }, // pll
[MT_CG_UPLL_D4]  = { .name = __stringify(MT_CG_UPLL_D4),  .mask = UPLL_D4_EN_BIT,  .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_UPLL_D2,  },
[MT_CG_UPLL_D6]  = { .name = __stringify(MT_CG_UPLL_D6),  .mask = UPLL_D6_EN_BIT,  .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_UPLL_D3,  },
[MT_CG_UPLL_D10] = { .name = __stringify(MT_CG_UPLL_D10), .mask = UPLL_D10_EN_BIT, .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_UPLL_D5,  },
[MT_CG_UPLL_D8]  = { .name = __stringify(MT_CG_UPLL_D8),  .mask = UPLL_D8_EN_BIT,  .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_UPLL_D4,  },
[MT_CG_UPLL_D12] = { .name = __stringify(MT_CG_UPLL_D12), .mask = UPLL_D12_EN_BIT, .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_UPLL_D6,  },
[MT_CG_UPLL_D20] = { .name = __stringify(MT_CG_UPLL_D20), .mask = UPLL_D20_EN_BIT, .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_UPLL_D10, },
[MT_CG_UPLL_D16] = { .name = __stringify(MT_CG_UPLL_D16), .mask = UPLL_D16_EN_BIT, .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_UPLL_D8,  },
[MT_CG_UPLL_D24] = { .name = __stringify(MT_CG_UPLL_D24), .mask = UPLL_D24_EN_BIT, .ops = &general_en_cg_clk_ops, .grp = &grps[CG_UPLL], .src = MT_CG_UPLL_D12, },

// CG_CTRL0 (PERI/INFRA)
[MT_CG_PWM_MM_SW_CG]		= { .name = __stringify(MT_CG_PWM_MM_SW_CG),		.mask = PWM_MM_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL0], .src = MT_CG_INVALID,  }, // rg_pwm_mux_sel
[MT_CG_CAM_MM_SW_CG]		= { .name = __stringify(MT_CG_CAM_MM_SW_CG),		.mask = CAM_MM_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL0], .src = MT_CG_INVALID,  }, // rg_cam_mux_sel
[MT_CG_MFG_MM_SW_CG]		= { .name = __stringify(MT_CG_MFG_MM_SW_CG),		.mask = MFG_MM_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL0], .src = MT_CG_INVALID,  }, // rg_mfg_gfmux_sel, rg_mfg_mux_sel
[MT_CG_SPM_52M_SW_CG]		= { .name = __stringify(MT_CG_SPM_52M_SW_CG),		.mask = SPM_52M_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL0], .src = MT_CG_INVALID,  }, // rg_spm_52m_ck_sel
[MT_CG_MIPI_26M_DBG_EN]		= { .name = __stringify(MT_CG_MIPI_26M_DBG_EN),		.mask = MIPI_26M_DBG_EN_BIT,	.ops = &general_en_cg_clk_ops,   .grp = &grps[CG_CTRL0], .src = MT_CG_INVALID,  }, // feature
[MT_CG_SCAM_MM_SW_CG]		= { .name = __stringify(MT_CG_SCAM_MM_SW_CG),		.mask = SCAM_MM_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL0], .src = MT_CG_INVALID,  }, 
[MT_CG_SC_26M_CK_SEL_EN]	= { .name = __stringify(MT_CG_SC_26M_CK_SEL_EN),	.mask = SC_26M_CK_SEL_EN_BIT,	.ops = &general_en_cg_clk_ops,   .grp = &grps[CG_CTRL0], .src = MT_CG_INVALID,  }, // feature
[MT_CG_SC_MEM_CK_OFF_EN]	= { .name = __stringify(MT_CG_SC_MEM_CK_OFF_EN),	.mask = SC_MEM_CK_OFF_EN_BIT,	.ops = &general_en_cg_clk_ops,   .grp = &grps[CG_CTRL0], .src = MT_CG_INVALID,  }, // feature
[MT_CG_SC_AXI_CK_OFF_EN]	= { .name = __stringify(MT_CG_SC_AXI_CK_OFF_EN),	.mask = SC_AXI_CK_OFF_EN_BIT,	.ops = &general_en_cg_clk_ops,   .grp = &grps[CG_CTRL0], .src = MT_CG_INVALID,  }, // feature
[MT_CG_ARM_EMICLK_WFI_GATING_DIS] = { .name = __stringify(MT_CG_ARM_EMICLK_WFI_GATING_DIS),	.mask = ARM_EMICLK_WFI_GATING_DIS_BIT,	.ops = &general_en_cg_clk_ops,   .grp = &grps[CG_CTRL0], .src = MT_CG_INVALID,  }, // feature
[MT_CG_ARMDCM_CLKOFF_EN]	= { .name = __stringify(MT_CG_ARMDCM_CLKOFF_EN),	.mask = ARMDCM_CLKOFF_EN_BIT,	.ops = &general_en_cg_clk_ops,   .grp = &grps[CG_CTRL0], .src = MT_CG_INVALID,  }, // feature

// CG_CTRL1 (PERI/INFRA)
[MT_CG_THEM_SW_CG]         = { .name = __stringify(MT_CG_THEM_SW_CG),         .mask = THEM_SW_CG_BIT,         .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // MT_CG_SYS_26M
[MT_CG_APDMA_SW_CG]        = { .name = __stringify(MT_CG_APDMA_SW_CG),        .mask = APDMA_SW_CG_BIT,        .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // AXIBUS
[MT_CG_I2C0_SW_CG]         = { .name = __stringify(MT_CG_I2C0_SW_CG),         .mask = I2C0_SW_CG_BIT,         .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // AXIBUS
[MT_CG_I2C1_SW_CG]         = { .name = __stringify(MT_CG_I2C1_SW_CG),         .mask = I2C1_SW_CG_BIT,         .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // AXIBUS
[MT_CG_AUXADC1_SW_CG]      = { .name = __stringify(MT_CG_AUXADC1_SW_CG),      .mask = AUXADC1_SW_CG_BIT,      .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // MT_CG_SYS_26M
[MT_CG_NFI_SW_CG]          = { .name = __stringify(MT_CG_NFI_SW_CG),          .mask = NFI_SW_CG_BIT,          .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // AXIBUS
[MT_CG_NFIECC_SW_CG]       = { .name = __stringify(MT_CG_NFIECC_SW_CG),       .mask = NFIECC_SW_CG_BIT,       .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // AXIBUS
[MT_CG_DEBUGSYS_SW_CG]     = { .name = __stringify(MT_CG_DEBUGSYS_SW_CG),     .mask = DEBUGSYS_SW_CG_BIT,     .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // AXIBUS
[MT_CG_PWM_SW_CG]          = { .name = __stringify(MT_CG_PWM_SW_CG),          .mask = PWM_SW_CG_BIT,          .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // AXIBUS
[MT_CG_UART0_SW_CG]        = { .name = __stringify(MT_CG_UART0_SW_CG),        .mask = UART0_SW_CG_BIT,        .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // rg_uart0_gfmux_sel
[MT_CG_UART1_SW_CG]        = { .name = __stringify(MT_CG_UART1_SW_CG),        .mask = UART1_SW_CG_BIT,        .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // rg_uart1_gfmux_sel
[MT_CG_BTIF_SW_CG]         = { .name = __stringify(MT_CG_BTIF_SW_CG),         .mask = BTIF_SW_CG_BIT,         .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // AXIBUS
[MT_CG_USB_SW_CG]          = { .name = __stringify(MT_CG_USB_SW_CG),          .mask = USB_SW_CG_BIT,          .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // AXIBUS
[MT_CG_FHCTL_SW_CG]        = { .name = __stringify(MT_CG_FHCTL_SW_CG),        .mask = FHCTL_SW_CG_BIT,        .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // MT_CG_SYS_26M
[MT_CG_AUXADC2_SW_CG]      = { .name = __stringify(MT_CG_AUXADC2_SW_CG),      .mask = AUXADC2_SW_CG_BIT,      .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // MT_CG_SYS_26M
[MT_CG_I2C2_SW_CG]         = { .name = __stringify(MT_CG_I2C2_SW_CG),         .mask = I2C2_SW_CG_BIT,         .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // rg_spinfi_gfmux_sel, rg_spinfi_mux_sel
[MT_CG_MSDC0_SW_CG]        = { .name = __stringify(MT_CG_MSDC0_SW_CG),        .mask = MSDC0_SW_CG_BIT,        .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // rg_msdc0_mux_sel
[MT_CG_MSDC1_SW_CG]        = { .name = __stringify(MT_CG_MSDC1_SW_CG),        .mask = MSDC1_SW_CG_BIT,        .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // rg_msdc1_mux_sel
[MT_CG_NFI2X_SW_CG]        = { .name = __stringify(MT_CG_NFI2X_SW_CG),        .mask = NFI2X_SW_CG_BIT,        .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // rg_pmicspi_mux_sel (all clk off and then clk off) (rg_pmic_sw_cg_ap (AP) && rg_PMIC_SW_CG_MD (MDSYS) && rg_PMIC_SW_CG_CONN (CONNSYS))
[MT_CG_PMIC_SW_CG_AP]      = { .name = __stringify(MT_CG_PMIC_SW_CG_AP),      .mask = PMIC_SW_CG_AP_BIT,      .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // rg_pmicspi_mux_sel (all clk off and then clk off) (rg_pmic_sw_cg_ap (AP) && rg_PMIC_SW_CG_MD (MDSYS) && rg_PMIC_SW_CG_CONN (CONNSYS))
[MT_CG_SEJ_SW_CG]          = { .name = __stringify(MT_CG_SEJ_SW_CG),          .mask = SEJ_SW_CG_BIT,          .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // MT_CG_SYS_26M, AXIBUS
[MT_CG_MEMSLP_DLYER_SW_CG] = { .name = __stringify(MT_CG_MEMSLP_DLYER_SW_CG), .mask = MEMSLP_DLYER_SW_CG_BIT, .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID   }, // feature
[MT_CG_SPI_SW_CG]          = { .name = __stringify(MT_CG_SPI_SW_CG),          .mask = SPI_SW_CG_BIT,          .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID   }, // feature
[MT_CG_APXGPT_SW_CG]       = { .name = __stringify(MT_CG_APXGPT_SW_CG),       .mask = APXGPT_SW_CG_BIT,       .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // MT_CG_SYS_26M, AXIBUS
[MT_CG_AUDIO_SW_CG]        = { .name = __stringify(MT_CG_AUDIO_SW_CG),        .mask = AUDIO_SW_CG_BIT,        .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // rg_aud_intbus_sel
[MT_CG_SPM_SW_CG]          = { .name = __stringify(MT_CG_SPM_SW_CG),          .mask = SPM_SW_CG_BIT,          .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // MT_CG_SYS_26M
[MT_CG_PMIC_SW_CG_MD]      = { .name = __stringify(MT_CG_PMIC_SW_CG_MD),      .mask = PMIC_SW_CG_MD_BIT,      .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // rg_pmicspi_mux_sel (all clk off and then clk off) (rg_pmic_sw_cg_ap (AP) && rg_pmic_sw_cg_md (MDSYS) && rg_pmic_sw_cg_conn (CONNSYS))
[MT_CG_PMIC_SW_CG_CONN]    = { .name = __stringify(MT_CG_PMIC_SW_CG_CONN),    .mask = PMIC_SW_CG_CONN_BIT,    .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // rg_pmicspi_mux_sel (all clk off and then clk off) (rg_pmic_sw_cg_ap (AP) && rg_pmic_sw_cg_md (MDSYS) && rg_pmic_sw_cg_conn (CONNSYS))
[MT_CG_PMIC_26M_SW_CG]     = { .name = __stringify(MT_CG_PMIC_26M_SW_CG),     .mask = PMIC_26M_SW_CG_BIT,     .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // MT_CG_SYS_26M
[MT_CG_AUX_SW_CG_ADC]      = { .name = __stringify(MT_CG_AUX_SW_CG_ADC),      .mask = AUX_SW_CG_ADC_BIT,      .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // MT_CG_SYS_26M
[MT_CG_AUX_SW_CG_TP]       = { .name = __stringify(MT_CG_AUX_SW_CG_TP),       .mask = AUX_SW_CG_TP_BIT,       .ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL1], .src = MT_CG_INVALID,  }, // MT_CG_SYS_26M

//CG_CTRL2
[MT_CG_RBIST_SW_CG]		= { .name = __stringify(MT_CG_RBIST_SW_CG),		.mask = RBIST_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },
[MT_CG_NFI_BUS_SW_CG]		= { .name = __stringify(MT_CG_NFI_BUS_SW_CG),		.mask = NFI_BUS_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },
[MT_CG_GCE_SW_CG]		= { .name = __stringify(MT_CG_GCE_SW_CG),		.mask = GCE_SW_CG_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },
[MT_CG_TRNG_SW_CG]		= { .name = __stringify(MT_CG_TRNG_SW_CG),		.mask = TRNG_SW_CG_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },
[MT_CG_SEJ_13M_SW_CG]		= { .name = __stringify(MT_CG_SEJ_13M_SW_CG),		.mask = SEJ_13M_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },
[MT_CG_AES_SW_CG]		= { .name = __stringify(MT_CG_AES_SW_CG),		.mask = AES_SW_CG_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },
[MT_CG_PWM_BCLK_SW_CG]		= { .name = __stringify(MT_CG_PWM_BCLK_SW_CG),		.mask = PWM_BCLK_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },
[MT_CG_PWM1_FBCLK_SW_CG]	= { .name = __stringify(MT_CG_PWM1_FBCLK_SW_CG),	.mask = PWM1_FBCLK_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },
[MT_CG_PWM2_FBCLK_SW_CG]	= { .name = __stringify(MT_CG_PWM2_FBCLK_SW_CG),	.mask = PWM2_FBCLK_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },
[MT_CG_PWM3_FBCLK_SW_CG]	= { .name = __stringify(MT_CG_PWM3_FBCLK_SW_CG),	.mask = PWM3_FBCLK_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },
[MT_CG_PWM4_FBCLK_SW_CG]	= { .name = __stringify(MT_CG_PWM4_FBCLK_SW_CG),	.mask = PWM4_FBCLK_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },
[MT_CG_PWM5_FBCLK_SW_CG]	= { .name = __stringify(MT_CG_PWM5_FBCLK_SW_CG),	.mask = PWM5_FBCLK_SW_CG_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_CTRL2], .src = MT_CG_INVALID,  },

// CG_MMSYS0
[MT_CG_DISP0_SMI_COMMON]	= { .name = __stringify(MT_CG_DISP0_SMI_COMMON),	.mask = SMI_COMMON_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
[MT_CG_DISP0_SMI_LARB0]		= { .name = __stringify(MT_CG_DISP0_SMI_LARB0),		.mask = SMI_LARB0_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_CAM_MDP]		= { .name = __stringify(MT_CG_DISP0_CAM_MDP),		.mask = CAM_MDP_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_MDP_RDMA]		= { .name = __stringify(MT_CG_DISP0_MDP_RDMA),		.mask = MDP_RDMA_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_MDP_RSZ0]		= { .name = __stringify(MT_CG_DISP0_MDP_RSZ0),		.mask = MDP_RSZ0_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_MDP_RSZ1]		= { .name = __stringify(MT_CG_DISP0_MDP_RSZ1),		.mask = MDP_RSZ1_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_MDP_TDSHP]		= { .name = __stringify(MT_CG_DISP0_MDP_TDSHP),		.mask = MDP_TDSHP_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_MDP_WDMA]		= { .name = __stringify(MT_CG_DISP0_MDP_WDMA),		.mask = MDP_WDMA_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_MDP_WROT]		= { .name = __stringify(MT_CG_DISP0_MDP_WROT),		.mask = MDP_WROT_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
[MT_CG_DISP0_FAKE_ENG]		= { .name = __stringify(MT_CG_DISP0_FAKE_ENG),		.mask = FAKE_ENG_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_DISP_OVL0]		= { .name = __stringify(MT_CG_DISP0_DISP_OVL0),		.mask = DISP_OVL0_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_DISP_RDMA0]	= { .name = __stringify(MT_CG_DISP0_DISP_RDMA0),	.mask = DISP_RDMA0_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_DISP_WDMA0]	= { .name = __stringify(MT_CG_DISP0_DISP_WDMA0),	.mask = DISP_WDMA0_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_DISP_COLOR]	= { .name = __stringify(MT_CG_DISP0_DISP_COLOR),	.mask = DISP_COLOR_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_DISP_AAL]		= { .name = __stringify(MT_CG_DISP0_DISP_AAL),		.mask = DISP_AAL_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_DISP_GAMMA]	= { .name = __stringify(MT_CG_DISP0_DISP_GAMMAG),	.mask = DISP_GAMMA_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },
//[MT_CG_DISP0_DISP_DITHER]	= { .name = __stringify(MT_CG_DISP0_DISP_DITHER),	.mask = DISP_DITHER_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS0], .src = MT_CG_INVALID, },


// CG_MMSYS1
[MT_CG_DISP1_DISP_PWM_MM]	= { .name = __stringify(MT_CG_DISP1_DISP_PWM_MM),	.mask = DISP_PWM_MM_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS1], .src = MT_CG_INVALID,	},
[MT_CG_DISP1_DISP_PWM_26M]	= { .name = __stringify(MT_CG_DISP1_DISP_PWM_26M),	.mask = DISP_PWM_26M_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS1], .src = MT_CG_INVALID,	},
[MT_CG_DISP1_DSI_ENGINE]	= { .name = __stringify(MT_CG_DISP1_DSI_ENGINE),	.mask = DSI_ENGINE_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS1], .src = MT_CG_INVALID,	},
[MT_CG_DISP1_DSI_DIGITAL]	= { .name = __stringify(MT_CG_DISP1_DSI_DIGITAL),	.mask = DSI_DIGITAL_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS1], .src = MT_CG_INVALID,	},
[MT_CG_DISP1_DPI_PIXEL]		= { .name = __stringify(MT_CG_DISP1_DPI_PIXEL),		.mask = DPI_PIXEL_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS1], .src = MT_CG_INVALID,	},
[MT_CG_DISP1_DPI_ENGINE]	= { .name = __stringify(MT_CG_DISP1_DPI_ENGINE),	.mask = DPI_PIXEL_BIT,		.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_MMSYS1], .src = MT_CG_INVALID,	},

// CG_IMGSYS
[MT_CG_LARB1_SMI_CKPDN]		= { .name = __stringify(MT_CG_LARB1_SMI_CKPDN),		.mask = LARB1_SMI_CKPDN_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_IMGSYS], .src = MT_CG_INVALID,	},
[MT_CG_CAM_SMI_CKPDN]		= { .name = __stringify(MT_CG_CAM_SMI_CKPDN),		.mask = CAM_SMI_CKPDN_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_IMGSYS], .src = MT_CG_INVALID,	},
[MT_CG_CAM_CAM_CKPDN]		= { .name = __stringify(MT_CG_CAM_CAM_CKPDN),		.mask = CAM_CAM_CKPDN_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_IMGSYS], .src = MT_CG_INVALID,	},
[MT_CG_SEN_TG_CKPDN]		= { .name = __stringify(MT_CG_SEN_TG_CKPDN),		.mask = SEN_TG_CKPDN_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_IMGSYS], .src = MT_CG_INVALID,	},
[MT_CG_SEN_CAM_CKPDN]		= { .name = __stringify(MT_CG_SEN_CAM_CKPDN),		.mask = SEN_CAM_CKPDN_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_IMGSYS], .src = MT_CG_INVALID,	},
[MT_CG_VCODEC_CKPDN]		= { .name = __stringify(MT_CG_VCODEC_CKPDN),		.mask = VCODEC_CKPDN_BIT,	.ops = &general_gate_cg_clk_ops, .grp = &grps[CG_IMGSYS], .src = MT_CG_INVALID,	},

// CG_MFG
[MT_CG_BG3D_SET]		= { .name = __stringify(MT_CG_BG3D_SET),    		.mask = BG3D_SET_BIT, 		.ops = &general_en_cg_clk_ops, .grp = &grps[CG_MFGSYS], .src = MT_CG_MFG_MM_SW_CG, },
[MT_CG_BG3D_CLR]		= { .name = __stringify(MT_CG_BG3D_CLR),    		.mask = BG3D_CLR_BIT, 		.ops = &general_en_cg_clk_ops, .grp = &grps[CG_MFGSYS], .src = MT_CG_MFG_MM_SW_CG, },

// CG_AUDIO
[MT_CG_AUD_PDN_AFE_EN]		= { .name = __stringify(MT_CG_AUD_PDN_AFE_EN),		.mask = AUD_PDN_AFE_EN_BIT,	.ops = &wo_clr_cg_clk_ops, .grp = &grps[CG_AUDIO], .src = MT_CG_AUDIO_SW_CG, },
[MT_CG_AUD_PDN_I2S_EN]		= { .name = __stringify(MT_CG_AUD_PDN_I2S_EN),		.mask = AUD_PDN_I2S_EN_BIT,	.ops = &wo_clr_cg_clk_ops, .grp = &grps[CG_AUDIO], .src = MT_CG_INVALID, }, // from connsys
[MT_CG_AUD_PDN_ADC_EN]		= { .name = __stringify(MT_CG_AUD_PDN_ADC_EN),		.mask = AUD_PDN_ADC_EN_BIT,	.ops = &wo_clr_cg_clk_ops, .grp = &grps[CG_AUDIO], .src = MT_CG_INVALID, }, // AXIBUS
[MT_CG_AUD_PDN_DAC_EN]		= { .name = __stringify(MT_CG_AUD_PDN_DAC_EN),		.mask = AUD_PDN_DAC_EN_BIT,	.ops = &wo_clr_cg_clk_ops, .grp = &grps[CG_AUDIO], .src = MT_CG_INVALID, }, // AXIBUS

//CG_INFRA_AO
[MT_CG_PLL2_CK]  		= { .name = __stringify(MT_CG_PLL2_CK),			.mask = PLL2_CK_BIT,		.ops = &general_en_cg_clk_ops,	.grp = &grps[CG_INFRA_AO], .src = MT_CG_MPLL_D2,  },
};
...
#if 1	//defined(CONFIG_CLKMGR_EMULATION)
...
static const struct clkmux_map _mt_clkmux_emi1x_gfmux_sel_map[] =
{
	...
	{ .val = 0x1,	.id = MT_CG_INVALID,	.mask = 0x2, },	//?
};
static const struct clkmux_map _mt_clkmux_axibus_gfmux_sel_map[] =
{
	{ .val = 0x1,	.id = MT_CG_SYS_26M,	.mask = 0xF << 4, }, // default
	{ .val = 0x2,	.id = MT_CG_MPLL_D11,	.mask = 0xF << 4, },
	{ .val = 0x4,	.id = MT_CG_MPLL_D12,	.mask = 0xF << 4, },
	{ .val = 0xc,	.id = MT_CG_INVALID,	.mask = 0xF << 4, },
};
static const struct clkmux_map _mt_clkmux_mfg_mux_sel_map[] =
{
	{ .val = 0x2,	.id = MT_CG_MPLL_D3,        .mask = 0x3 << 8, },
	{ .val = 0x3,	.id = MT_CG_UPLL_D2,        .mask = 0x3 << 8, },
	{ .val = 0x4,	.id = MT_CG_SYS_26M,        .mask = 0x3 << 8, },
	{ .val = 0x5,	.id = MT_CG_MPLL_D4,        .mask = 0x3 << 8, },
};
static const struct clkmux_map _mt_clkmux_msdc0_mux_sel_map[] =
{
	{ .val = 0x0,	.id = MT_CG_MPLL_D12,	.mask = 0x7 << 11, },
	{ .val = 0x1,	.id = MT_CG_MPLL_D10,	.mask = 0x7 << 11, },
	{ .val = 0x2,	.id = MT_CG_MPLL_D8,	.mask = 0x7 << 11, },
	{ .val = 0x3,	.id = MT_CG_UPLL_D7,	.mask = 0x7 << 11, },
	{ .val = 0x4,	.id = MT_CG_MPLL_D7,	.mask = 0x7 << 11, },
	{ .val = 0x5,	.id = MT_CG_MPLL_D8,	.mask = 0x7 << 11, },
	{ .val = 0x6,	.id = MT_CG_SYS_26M,	.mask = 0x7 << 11, }, // default
	{ .val = 0x7,	.id = MT_CG_UPLL_D6,	.mask = 0x7 << 11, },
};
static const struct clkmux_map _mt_clkmux_cam_mux_sel_map[] =
{
	{ .val = 0x1,	.id = MT_CG_SYS_26M,	.mask = 0x7 << 15, },
	{ .val = 0x2,	.id = MT_CG_USB_48M,	.mask = 0x7 << 15, },
	{ .val = 0x4,	.id = MT_CG_UPLL_D6,	.mask = 0x7 << 15, },
    	
};
static const struct clkmux_map _mt_clkmux_pwm_mm_mux_sel_map[] =
{
	{ .val = 0x0,	.id = MT_CG_SYS_26M,	.mask = 0x1 << 18, }, // default
	{ .val = 0x1,	.id = MT_CG_UPLL_D12,	.mask = 0x1 << 18, },
};

static const struct clkmux_map _mt_clkmux_uart1_gfmux_sel_map[] =
{
	{ .val = 0x0,	.id = MT_CG_SYS_26M,	.mask = 0x1 << 19, }, // default
	{ .val = 0x1,	.id = MT_CG_UPLL_D24,	.mask = 0x1 << 19, },
};
static const struct clkmux_map _mt_clkmux_msdc1_mux_sel_map[] =
{
	{ .val = 0x0,	.id = MT_CG_MPLL_D12,	.mask = 0x7 << 20, },
	{ .val = 0x1,	.id = MT_CG_MPLL_D10,	.mask = 0x7 << 20, },
	{ .val = 0x2,	.id = MT_CG_MPLL_D8,	.mask = 0x7 << 20, },
	{ .val = 0x3,	.id = MT_CG_UPLL_D7,	.mask = 0x7 << 20, },
	{ .val = 0x4,	.id = MT_CG_MPLL_D7,	.mask = 0x7 << 20, },
	{ .val = 0x5,	.id = MT_CG_MPLL_D8,	.mask = 0x7 << 20, },
	{ .val = 0x6,	.id = MT_CG_SYS_26M,	.mask = 0x7 << 20, }, // default
	{ .val = 0x7,	.id = MT_CG_UPLL_D6,	.mask = 0x7 << 20, },
};
#if 0
...
{
	{ .val = 0x0,	.id = MT_CG_UPLL_D20,	.mask = 0x3 << 24, }, // default
	{ .val = 0x1,	.id = MT_CG_USB_48M,	.mask = 0x3 << 24, },
	{ .val = 0x2,	.id = MT_CG_UPLL_D16,	.mask = 0x3 << 24, },
	{ .val = 0x3,	.id = MT_CG_SYS_26M,	.mask = 0x3 << 24, },
};

static const struct clkmux_map _mt_clkmux_aud_hf_26m_sel_map[] =
{
	{ .val = 0x0,	.id = MT_CG_SYS_26M,	.mask = 0x1 << 26, }, // default
	{ .val = 0x1,	.id = MT_CG_SYS_26M,	.mask = 0x1 << 26, }, // hopping 33M
};

// just alias and would replace @ aud_intbus_clkmux_ops
static const struct clkmux_map _mt_clkmux_aud_intbus_sel_map[] =
{
	{ .val = 0x1,	.id = MT_CG_SYS_26M,	.mask = 0x7 << 27, }, // default
	{ .val = 0x2,	.id = MT_CG_MPLL_D24,	.mask = 0x7 << 27, }, //
	{ .val = 0x4,	.id = MT_CG_MPLL_D12,	.mask = 0x7 << 27, }, //
};

//Clock Mux Selection1
static const struct clkmux_map _mt_clkmux_nfi2x_gfmux_sel_map[] =
{
	{ .val = 0x8,	.id = MT_CG_SYS_26M,	.mask = 0x1 << 3, },
	{ .val = 0x11,	.id = MT_CG_MPLL_D8,	.mask = 0x7F, },
	{ .val = 0x12,	.id = MT_CG_MPLL_D10,	.mask = 0x7F, },
	{ .val = 0x14,	.id = MT_CG_MPLL_D7,	.mask = 0x7F, },
	{ .val = 0x21,	.id = MT_CG_MPLL_D8,	.mask = 0x7F, },
	{ .val = 0x22,	.id = MT_CG_MPLL_D7,	.mask = 0x7F, },
	{ .val = 0x24,	.id = MT_CG_MPLL_D20,	.mask = 0x7F, },
	{ .val = 0x61,	.id = MT_CG_MPLL_D7,	.mask = 0x7F, },
...
{
	{ .val = 0x0,	.id = MT_CG_SYS_26M,	.mask = 0x1 << 7, },
	{ .val = 0x1,	.id = MT_CG_INVALID,	.mask = 0x1 << 7, },
};

static const struct clkmux_map _mt_clkmux_mfg_gfmux_sel_map[] =
{
	{ .val = 0x10,	.id = MT_CG_MPLL_D3,	.mask = 0x1 << 12, },
	{ .val = 0x21,	.id = MT_CG_MPLL_D5,	.mask = 0x3F << 8, },
	{ .val = 0x22,	.id = MT_CG_MPLL_D7,	.mask = 0x3F << 8, },
	{ .val = 0x24,	.id = MT_CG_MPLL_D14,	.mask = 0x3F << 8, },
};

static const struct clkmux_map _mt_clkmux_spi_gfmux_sel_map[] =
{
	{ .val = 0x0,	.id = MT_CG_SYS_26M,	.mask = 0x1 << 14, }, // default
	{ .val = 0x1,	.id = MT_CG_UPLL_D12,	.mask = 0x1 << 14, },
};

static const struct clkmux_map _mt_clkmux_ddrphycfg_gfmux_sel_map[] =
{
	{ .val = 0x0,	.id = MT_CG_SYS_26M,	.mask = 0x1 << 15, }, // default
	{ .val = 0x1,	.id = MT_CG_MPLL_D8,	.mask = 0x1 << 15, },
};

static const struct clkmux_map _mt_clkmux_smi_gfmux_sel_map[] =
{
	{ .val = 0x0,	.id = MT_CG_SYS_26M,	.mask = 0x8 << 19, }, //
	{ .val = 0x9,	.id = MT_CG_MPLL_D5,	.mask = 0xF << 16, }, //
	{ .val = 0xa,	.id = MT_CG_MPLL_D7,	.mask = 0xF << 16, }, //
	{ .val = 0xc,	.id = MT_CG_MPLL_D14,	.mask = 0xF << 16, }, //
};

static const struct clkmux_map _mt_clkmux_usb_gfmux_sel_map[] =
{
	{ .val = 0x1,	.id = MT_CG_SYS_26M,	.mask = 0x7 << 20, }, // 
	{ .val = 0x2,	.id = MT_CG_UPLL_D8,	.mask = 0x7 << 20, }, //
	{ .val = 0x4,	.id = MT_CG_MPLL_D20,	.mask = 0x7 << 20, }, //
};

static const struct clkmux_map _mt_clkmux_scam_mux_sel_map[] =
{
	{ .val = 0x1,	.id = MT_CG_SYS_26M,	.mask = 0x7 << 23, }, // 
	{ .val = 0x2,	.id = MT_CG_MPLL_D7,	.mask = 0x7 << 23, }, //
	{ .val = 0x4,	.id = MT_CG_MPLL_D12,	.mask = 0x7 << 23, }, //
};
...
static cg_clk_id general_clkmux_get_op(struct clkmux *mux)
{
    ...
    {
        pr_debug(""HEX_FMT" >> "HEX_FMT", "HEX_FMT", "HEX_FMT"\n",mux->map[i].id, mux->map[i].val, mux->map[i].mask, reg_val);
...
static unsigned int MT_CLKMUX_AUD_26M_SEL = 0;
void clkmgr_faudintbus_pll2sq(void)
{
    MT_CLKMUX_AUD_26M_SEL = clk_readl(CLK_MUX_SEL0);
    clk_writel(CLK_MUX_SEL0, (MT_CLKMUX_AUD_26M_SEL & 0xC3FFFFFF) | 0x8000000);
    return;
}

void clkmgr_faudintbus_sq2pll(void)
{
    clk_writel(CLK_MUX_SEL0, MT_CLKMUX_AUD_26M_SEL);
    return;
}
//
...
static void larb_clk_prepare(int larb_idx)
{
    ...
    case MT_LARB0:
        {
        #if 0
            struct cg_clk *cg_clk = id_to_clk(MT_CG_DISP0_SMI_LARB0);

            // BUG_ON(PWR_ON == cg_clk->ops->get_state(cg_clk)); // TODO: check it

            cg_clk->ops->enable(cg_clk);
        #else // XXX: if remove MT_CG_SMI_COMMON & MT_CG_SMI_LARB0
...
return;
    ...
    if(en)
        clk_setl(AP_PLL_CON0, 1 << 7);
    else
        clk_clrl(AP_PLL_CON0, 1 << 7);
...
// INIT related
//
static void dump_pr_debug(void);
...
static void subsys_all_force_on(void)
{
    ...
    {
        pr_debug("[%s]: not force to turn on MFG\n", __func__);
    }
...
//                break;
    ...
    for (i = CG_UPLL; i >= CG_MPLL; i--) // XXX: tricky (down to up)
    {
        clk = &clks[i];
        clk->cnt--;
...
int mt_clkmgr_init(void)
{
	...
	grps[CG_MPLL].set_addr = MPLL_FREDIV_EN;
	grps[CG_MPLL].clr_addr = MPLL_FREDIV_EN;
	grps[CG_MPLL].sta_addr = MPLL_FREDIV_EN;
	grps[CG_UPLL].set_addr = UPLL_FREDIV_EN;
	grps[CG_UPLL].clr_addr = UPLL_FREDIV_EN;
	...
	grps[CG_MMSYS0].set_addr = MMSYS_CG_CLR0;
	grps[CG_MMSYS0].clr_addr = MMSYS_CG_CLR0;
	grps[CG_MMSYS0].sta_addr = MMSYS_CG_CLR0;	
	grps[CG_MMSYS1].set_addr = MMSYS_CG_CLR1;
	grps[CG_MMSYS1].clr_addr = MMSYS_CG_CLR1;
	grps[CG_MMSYS1].sta_addr = MMSYS_CG_CLR1;
	grps[CG_IMGSYS].set_addr = IMG_CG_CON;
	grps[CG_IMGSYS].clr_addr = IMG_CG_CON;
...
//	muxs[MT_CLKMUX_SPM_52M_CK_SEL].base_addr = CLK_MUX_SEL0;
...
#if 0
	conn_power_on();
	printk("%s conn_power_on() API test\n", __FUNCTION__);
	printk("%s subsys_is_on = %d\n", __FUNCTION__, subsys_is_on(SYS_CON));

	conn_power_off();
	printk("%s conn_power_off() API test\n", __FUNCTION__);
	printk("%s subsys_is_on = %d\n", __FUNCTION__, subsys_is_on(SYS_CON));
	
	enable_subsys(SYS_CON,"clkmgrtest");
	printk("%s enable_subsys() API test\n", __FUNCTION__);
	printk("%s subsys_is_on = %d\n", __FUNCTION__, subsys_is_on(SYS_CON));

	disable_subsys(SYS_CON,"clkmgrtest");
	printk("%s disable_subsys() API test\n", __FUNCTION__);
	printk("%s subsys_is_on = %d\n", __FUNCTION__, subsys_is_on(SYS_CON));

	printk("%s subsys CLOCK on/OFF test start\n", __FUNCTION__);
#endif
#if 0
	for (i = CG_MMSYS0_FROM; i < NR_CLKS; i++)
	{
//		printk("%s clock_is_on = %d\n", __FUNCTION__, clock_is_on(i));
		mt_disable_clock(i, "clkmgr_disable");
		printk("%s clock_is_on = %d\n", __FUNCTION__, clock_is_on(i));
		mt_enable_clock(i,"clkmgr_enable");
		printk("%s clock_is_on = %d\n", __FUNCTION__, clock_is_on(i));
	}
	printk("%s subsys CLOCK on/OFF test end\n", __FUNCTION__);
#endif
#if 0
	printk("%s subsys MUX test start\n", __FUNCTION__);
	{
		printk("%s MUX = %x\n", __FUNCTION__, clkmux_get(MT_CLKMUX_CAM_MUX_SEL, "clkmgr_test"));
		clkmux_get(MT_CLKMUX_CAM_MUX_SEL, "clkmgr_test");
		clkmux_sel(MT_CLKMUX_CAM_MUX_SEL, MT_CG_USB_48M, "clkmgr_test");
		printk("%s MUX = %x\n", __FUNCTION__, clkmux_get(MT_CLKMUX_CAM_MUX_SEL, "clkmgr_test"));
	}
	printk("%s subsys MUX test end\n", __FUNCTION__);
...
// DEBUG related
//
void dump_pr_debug_by_id(cg_clk_id id)
{
    struct cg_clk *clk = id_to_clk(id);
...
static void dump_pr_debug(void)
{
    ...
    for (i = 0; i < NR_CLKS; i++)
    {
        dump_pr_debug_by_id(i);
    }

#if 1   // XXX: dump for control table
    for (i = 0; i < NR_CLKS; i++)
    {
        struct cg_clk *clk;
        ...
        pr_debug("[%s] set:%d clr:%d sta:%d mask:%d %s]\n",
                 clk->name,
                         ...
                         int count, int *eof, void *data)
{
    ...
    p += sprintf(p, "[CLK_MUX_SEL1]="HEX_FMT"\n", clk_readl(CLK_MUX_SEL1));
    p += sprintf(p, "\n********** clk_test help *********\n");
                             ...
                             unsigned long count, void *data)
{
    ...
    if (sscanf(desc, "%u", &delay) == 1)
    {
        ...
        pr_debug("udelay(%u) test: pre="HEX_FMT", pos="HEX_FMT", delta=%u\n",
