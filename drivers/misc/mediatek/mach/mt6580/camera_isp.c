...
//#include <smi_common.h>// temporally remark for build pass (Frederic is checking need or not)
...
static MINT32 ISP_DumpReg(MVOID)
{
    ...
    //Mipi source
    LOG_DBG("[0x%08X %08X],[0x%08X %08X]", (unsigned int)(0x10011000+0x830), (unsigned int)ISP_RD32(ISP_MIPI_ANA_ADDR+0x830),(unsigned int)(0x10011000+0x830), (unsigned int)ISP_RD32(ISP_MIPI_ANA_ADDR+0x830));
    LOG_DBG("[0x%08X %08X],[0x%08X %08X]", (unsigned int)(0x10011000+0xC30), (unsigned int)ISP_RD32(ISP_MIPI_ANA_ADDR+0xc30),(unsigned int)(0x10011000+0xC30), (unsigned int)ISP_RD32(ISP_MIPI_ANA_ADDR+0xc30));
