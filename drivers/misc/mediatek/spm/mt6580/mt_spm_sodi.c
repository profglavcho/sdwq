...
#define SODI_EARLY_PORTING          1

#define SPM_BYPASS_SYSPWREQ         1 //JTAG is used

#define SODI_DVT_APxGPT             1

#if SODI_DVT_APxGPT
#define SPM_DEBUG_FW                1
#define SODI_DVT_STEP_BY_STEP       1 
#define SODI_DVT_WAKEUP             1
#define SODI_DVT_PCM_TIMER_DISABLE  1
...
#if SODI_EARLY_PORTING
void __attribute__((weak)) enable_soidle_by_bit(int id){}
void __attribute__((weak)) disable_soidle_by_bit(int id){}
...
#if 0 //Rainier has no Vcore DVFS
