...
#define POWER_ON_VAL1_DEF	0x60015830 //mt6735//mt6580
...
#define R13_EXT_SRCLKENA_2	(1U << 2) //mt6580
#define R13_MD1_SRCLKENA	(1U << 3)
#define R13_MD1_APSRC_REQ	(1U << 4)
#define R13_AP_MD1SRC_ACK	(1U << 5)
#define R13_MD2_SRCLKENA	(1U << 6)
#define R13_MD2_APSRC_REQ	(1U << 7)  //mt6580
#define R13_AP_MD2SRC_ACK	(1U << 8)  //mt6580
#define R13_MD1_STATE    (1U << 9)  //mt6580
#define R13_MD2_STATE    (1U << 10)  //mt6580
#define R13_MM_STATE	(1U << 11)  //mt6580
#define R13_MD_DDR_EN		(1U << 12)
#define R13_CONN_STATE		(1U << 13)//mt6580
...
#define CC_SYSCLK0_EN_0		(1U << 0) //TODO: check for Rainier
#define CC_SYSCLK0_EN_1		(1U << 1) //TODO: check for Rainier
#define CC_SYSCLK1_EN_0		(1U << 2) //TODO: check for Rainier
#define CC_SYSCLK1_EN_1		(1U << 3) //TODO: check for Rainier
#define CC_SYSSETTLE_SEL	(1U << 4)
#define CC_LOCK_INFRA_DCM	(1U << 5)
#define CC_SRCLKENA_MASK_0	(1U << 6) //TODO: check for Rainier
#define CC_CXO32K_RM_EN_MD1	(1U << 9)
#define CC_CXO32K_RM_EN_MD2	(1U << 10)
#define CC_CLKSQ0_SEL		(1U << 11) //mt6580
#define CC_CLKSQ1_SEL		(1U << 12)
#define CC_SRCLKEN0_EN	(1U << 13)  //mt6580
#define CC_SRCLKEN1_EN	(1U << 14)  //mt6580
#define CC_CXO32K_RM_EN_CONN	(1U << 15) //mt6580
...
#define WAKE_MISC_TWAM		(1U << 16) //mt6735//mt6580
#define WAKE_MISC_PCM_TIMER	(1U << 17) //mt6735//mt6580
#define WAKE_MISC_CPU_WAKE	(1U << 18) //mt6735//mt6580
...
struct pwr_ctrl {
	...
	u8 md_vrf18_req_mask_b; //mt6735

        /* for CONN */
        u8 conn_mask;

	/* for MM */
	u8 gce_req_mask; //mt6735
	u8 disp_req_mask;
	u8 mfg_req_mask;
...
#ifdef SPM_VCORE_EN
	flags |= SPM_VCORE_DVFS_EN; //TODO: check for Rainier
#endif
...
{
	//TODO: check mainpll pdn flag for Rainier
